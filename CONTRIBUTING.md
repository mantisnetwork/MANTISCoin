Contributing to MANTISCoin
============================

The MANTISCoin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/MANTIScoin-project/MANTIScoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the MANTISCoin project, and is not to be
confused with overall MANTISCoin Network Protocol consensus changes.

Whether a pull request is merged into MANTISCoin rests with the project merge
...
Patches that change MANTISCoin consensus rules are considerably more involved than
...
Where a patchset proposes to change the MANTISCoin consensus, it must have been
...
The project leader is the release manager for each MANTISCoin release.
