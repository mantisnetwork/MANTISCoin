...
The script [extract-osx-sdk.sh](https://github.com/MANTIScoin-project/MANTIScoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
MANTIScoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/MANTIScoin-project/MANTIScoin/blob/master/doc/README_osx.md) for troubleshooting tips.
