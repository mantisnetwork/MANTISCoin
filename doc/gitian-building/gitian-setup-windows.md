...
The build script we'll be using is contained in the MANTISCoin github repository ([contrib/gitian-build.py](https://github.com/MANTIScoin-project/MANTIScoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the MANTISCoin repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/MANTISCoin-Project/MANTISCoin/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, MANTIScoin-detached-sigs, and MANTIScoin GitHub repos.
