...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MANTISCoin MANTIScoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  MANTIScoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MANTIScoin transaction") + "\n" +
                               "  MANTIScoin-tx [options] -create [commands]   " + _("Create hex-encoded MANTIScoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MANTIScoin transaction
