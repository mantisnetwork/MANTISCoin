...
extern const char * const MANTISCoin_CONF_FILENAME;
extern const char * const MANTISCoin_PID_FILENAME;
extern const char * const MANTISCoin_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("MANTIScoin-%s", name);
