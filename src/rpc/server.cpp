...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    if (jsonRequest.fHelp || jsonRequest.params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop MANTISCoin server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MANTISCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MANTISCoin features */
        {"MANTIScoin", "listmasternodes", &listmasternodes, true },
        {"MANTIScoin", "getmasternodecount", &getmasternodecount, true },
        {"MANTIScoin", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"MANTIScoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"MANTIScoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"MANTIScoin", "masternodecurrent", &masternodecurrent, true },
        {"MANTIScoin", "startmasternode", &startmasternode, true },
        {"MANTIScoin", "createmasternodekey", &createmasternodekey, true },
        {"MANTIScoin", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"MANTIScoin", "listmasternodeconf", &listmasternodeconf, true },
        {"MANTIScoin", "getmasternodestatus", &getmasternodestatus, true },
        {"MANTIScoin", "getmasternodewinners", &getmasternodewinners, true },
        {"MANTIScoin", "getmasternodescores", &getmasternodescores, true },
        {"MANTIScoin", "preparebudget", &preparebudget, true },
        {"MANTIScoin", "submitbudget", &submitbudget, true },
        {"MANTIScoin", "mnbudgetvote", &mnbudgetvote, true },
        {"MANTIScoin", "getbudgetvotes", &getbudgetvotes, true },
        {"MANTIScoin", "getnextsuperblock", &getnextsuperblock, true },
        {"MANTIScoin", "getbudgetprojection", &getbudgetprojection, true },
        {"MANTIScoin", "getbudgetinfo", &getbudgetinfo, true },
        {"MANTIScoin", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"MANTIScoin", "mnfinalbudget", &mnfinalbudget, true },
        {"MANTIScoin", "checkbudgets", &checkbudgets, true },
        {"MANTIScoin", "mnsync", &mnsync, true },
        {"MANTIScoin", "spork", &spork, true },
...
{
    return "> MANTIScoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:2612/\n";
}
