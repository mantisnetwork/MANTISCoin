...
#include "qt/MANTIScoin/forms/ui_send.h"
#include "qt/MANTIScoin/addnewcontactdialog.h"
#include "qt/MANTIScoin/qtutils.h"
#include "qt/MANTIScoin/sendchangeaddressdialog.h"
#include "qt/MANTIScoin/optionbutton.h"
#include "qt/MANTIScoin/sendconfirmdialog.h"
#include "qt/MANTIScoin/myaddressrow.h"
#include "qt/MANTIScoin/guitransactionsutils.h"
...
SendWidget::SendWidget(MANTISCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::send),
    ...
    btnContacts(new QPushButton())
{
    ...
    setCssProperty(coinIcon, "coin-icon-mntis");
...
void SendWidget::onContactMultiClicked()
{
    if (focusedEntry) {
        ...
        CTxDestination mntisAdd = DecodeDestination(address.toStdString());
        if (walletModel->isMine(mntisAdd)) {
        ...
        if (dialog->res) {
            ...
            if (walletModel->updateAddressBookLabels(mntisAdd, dialog->getLabel().toStdString(),
                    AddressBook::AddressBookPurpose::SEND)) {
