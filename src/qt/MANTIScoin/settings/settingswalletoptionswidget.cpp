...
#include "qt/MANTIScoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/MANTIScoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(MANTISCoinGUI* _window, QWidget *parent) :
