...
#include "qt/MANTIScoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(MANTISCoinGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &MANTISCoinGUI::openFAQ);
