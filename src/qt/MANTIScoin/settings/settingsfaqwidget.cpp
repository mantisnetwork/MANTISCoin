...
#include "qt/MANTIScoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/MANTIScoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(MANTISCoinGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
           ...
           ui->labelNumber_UnspendableMNTIS,
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableMNTIS,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableMNTIS,
    ...
    setCssProperty({
              ui->pushButton_Intro,
              ui->pushButton_UnspendableMNTIS,
              ui->pushButton_Stake,
    ...
    connect(ui->pushButton_UnspendableMNTIS, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableMNTIS);});
    ...
    if (parent)
        connect(parent, &MANTISCoinGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
