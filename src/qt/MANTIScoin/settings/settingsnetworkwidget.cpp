...
#include "qt/MANTIScoin/settings/settingsnetworkwidget.h"
#include "qt/MANTIScoin/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/MANTIScoin/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(MANTISCoinGUI* _window, QWidget *parent) :
