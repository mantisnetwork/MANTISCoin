...
#include "qt/MANTIScoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/MANTIScoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(MANTISCoinGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to MANTISCoinGUI::handleRestart()
