...
#include "qt/MANTIScoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/MANTIScoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(MANTISCoinGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MANTIS Coin RPC console.") + "<br>" +
