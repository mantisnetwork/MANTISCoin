...
#include "qt/MANTIScoin/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(MANTISCoinGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("MANTISCoin_tx_csv_export(*.csv)") : tr("MANTISCoin_addresses_csv_export(*.csv)"),
                                        nullptr);
