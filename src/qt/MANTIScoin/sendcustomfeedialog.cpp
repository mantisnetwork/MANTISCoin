...
#include "qt/MANTIScoin/sendcustomfeedialog.h"
#include "qt/MANTIScoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(MANTISCoinGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &MANTISCoinGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
