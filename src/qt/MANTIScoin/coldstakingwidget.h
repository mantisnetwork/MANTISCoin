...
#include "qt/MANTIScoin/furabstractlistitemdelegate.h"
#include "qt/MANTIScoin/txviewholder.h"
#include "qt/MANTIScoin/tooltipmenu.h"
#include "qt/MANTIScoin/sendmultirow.h"
#include "qt/MANTIScoin/coldstakingmodel.h"
#include "qt/MANTIScoin/contactsdropdown.h"
...
public:
    explicit ColdStakingWidget(MANTISCoinGUI* parent);
    ~ColdStakingWidget();
