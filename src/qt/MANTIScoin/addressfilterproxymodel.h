...
#ifndef MANTISCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define MANTISCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //MANTISCoin_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
