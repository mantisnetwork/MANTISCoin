...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, MANTISCoinGUI* gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog* widget, MANTISCoinGUI* gui, double posX = 3);
