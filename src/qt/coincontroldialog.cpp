...
void CoinControlDialog::updateLabels()
{
    ...
    int nDisplayUnit = BitcoinUnits::MNTIS;
    ...
    for (PAIRTYPE(QString, std::vector<COutput>) coins : mapCoins) {
        ...
        for(const COutput& out: coins.second) {
            ...
            if (haveDest) {
                ...
                // if listMode or change => show MANTISCoin address. In tree mode, address is not shown again for direct wallet address outputs
