...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MANTIS Coin"),
     ...
     * override -datadir in the MANTIScoin.conf file in the default data directory
     * (to be consistent with MANTIScoind behavior)
     */
