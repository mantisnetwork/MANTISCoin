...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            MANTISCoinGUI* window = static_cast<MANTISCoinGUI*>(parentWidget());
...
{
    MANTISCoinGUI* gui = static_cast<MANTISCoinGUI*>(parentWidget());
...
{
    hide();
    static_cast<MANTISCoinGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("MANTISCoin will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your MNTISs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
