...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(MNTIS);
    unitlist.append(mMNTIS);
    unitlist.append(uMNTIS);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case MNTIS:
        return QString("MANTIS coin");
    case mMNTIS:
        return QString("mMANTIS coin");
    case uMNTIS:
        return QString::fromUtf8("uMANTIS coin");
    default:
        return QString("???");
    }
}
