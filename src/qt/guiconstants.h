...
/* MANTISCoin GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MANTISCoin"
#define QAPP_ORG_DOMAIN "MANTIScoin.org"
#define QAPP_APP_NAME_DEFAULT "MANTISCoin-Qt"
#define QAPP_APP_NAME_TESTNET "MANTISCoin-Qt-testnet"
