...
/** Utility functions used by the MANTISCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render MANTISCoin addresses in monospace font
...
// Parse "MANTIScoin:" URI into recipient object, return true on successful parsing
