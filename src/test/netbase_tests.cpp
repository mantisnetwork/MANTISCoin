...
#include "netbase.h"
#include "test/test_MANTIScoin.h"
...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("127.0.0.1:2611", "127.0.0.1", 2611));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:2611", "127.0.0.1", 2611));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:2611", "::ffff:127.0.0.1", 2611));
    BOOST_CHECK(TestSplitHost("[::]:2611", "::", 2611));
    BOOST_CHECK(TestSplitHost("::2611", "::2611", -1));
    BOOST_CHECK(TestSplitHost(":2611", "", 2611));
    BOOST_CHECK(TestSplitHost("[]:2611", "", 2611));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:2611", "127.0.0.1:2611"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:2611", "[::]:2611"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
