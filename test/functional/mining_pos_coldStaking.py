...
from test_framework.MANTIScoin_node import MANTISCoinTestNode
...
class MANTISCoin_ColdStakingTest(MANTISCoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(MANTISCoinTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 MNTIS from the pot)
...
if __name__ == '__main__':
    MANTISCoin_ColdStakingTest().main()
