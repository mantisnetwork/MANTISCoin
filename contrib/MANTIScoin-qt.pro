...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/MANTIScoin-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/MANTIScoin-cli.cpp \
           src/MANTIScoin-tx.cpp \
           src/MANTIScoin.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/MANTIScoin.qrc src/qt/MANTIScoin_locale.qrc

TRANSLATIONS += src/qt/locale/MANTIScoin_bg.ts \
                src/qt/locale/MANTIScoin_de.ts \
                src/qt/locale/MANTIScoin_en.ts \
                src/qt/locale/MANTIScoin_es.ts \
                src/qt/locale/MANTIScoin_fi.ts \
                src/qt/locale/MANTIScoin_fr.ts \
                src/qt/locale/MANTIScoin_it.ts \
                src/qt/locale/MANTIScoin_ja.ts \
                src/qt/locale/MANTIScoin_pl.ts \
                src/qt/locale/MANTIScoin_pt.ts \
                src/qt/locale/MANTIScoin_ru.ts \
                src/qt/locale/MANTIScoin_sk.ts \
                src/qt/locale/MANTIScoin_sv.ts \
                src/qt/locale/MANTIScoin_vi.ts \
                src/qt/locale/MANTIScoin_zh_CN.ts \
                src/qt/locale/MANTIScoin_zh_TW.ts
